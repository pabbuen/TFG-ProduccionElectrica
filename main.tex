...
La primera de las puertas se denomina ``puerta del
olvido''($\mathbf{F}_{t}$). Es la parte de la red que se encarga 
de decidir que porcentaje de la memória a largo plazo
